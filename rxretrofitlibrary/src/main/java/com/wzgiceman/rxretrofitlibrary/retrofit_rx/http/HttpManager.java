...
public class HttpManager {
    ...
    public void doHttpDeal(BaseApi basePar) {
        ...
        Observable observable = basePar.getObservable(retrofit)
                ...
                /*生命周期管理*/
                .compose(basePar.getRxAppCompatActivity().bindToLifecycle())     //实现当前组件生命周期结束时，自动取消对Observable订阅
//                .compose(basePar.getRxAppCompatActivity().bindUntilEvent(ActivityEvent.DESTROY))   //实现当前组件生命周期结束时，自动取消对Observable订阅   使用要求版本更高（1.0）
                /*http请求线程*/
