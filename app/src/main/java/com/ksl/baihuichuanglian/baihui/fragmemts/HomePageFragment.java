...
import com.ksl.baihuichuanglian.baihui.LinearLayoutManager;
 ...
 * 备注：
 */
public class HomePageFragment extends Fragment implements OnRecyclerItemClickLitener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        findView(getActivity(), rootView);   //初始化
...
//                                Log.e("aaaaa", "结果："+ retrofitEntity.getData().getHome_img_ad_list().get(1).getImg());
     ...
     * @param rootView
     */
    private void findView(Activity mContext, View rootView) {
        convenientBanner = (ConvenientBanner) rootView.findViewById(R.id.convenientBanner);

        btnScan = (ImageView) rootView.findViewById(R.id.iv_index_scan);
        btnScan.setOnClickListener(this);
        btnLocation = (ImageView) rootView.findViewById(R.id.iv_index_location);
        btnLocation.setOnClickListener(this);

        btnCategory1 = (TextView) rootView.findViewById(R.id.tv_category_1);
        btnCategory2 = (TextView) rootView.findViewById(R.id.tv_category_2);
        btnCategory3 = (TextView) rootView.findViewById(R.id.tv_category_3);
        btnCategory4 = (TextView) rootView.findViewById(R.id.tv_category_4);
        btnCategory5 = (TextView) rootView.findViewById(R.id.tv_category_5);
        btnCategory6 = (TextView) rootView.findViewById(R.id.tv_category_6);
        btnCategory7 = (TextView) rootView.findViewById(R.id.tv_category_7);
        btnCategory8 = (TextView) rootView.findViewById(R.id.tv_category_8);
        ...
        ivCustom1 = (ImageView) rootView.findViewById(R.id.iv_custom1);
        ivCustom2 = (ImageView) rootView.findViewById(R.id.iv_custom2);
        ivCustom3 = (ImageView) rootView.findViewById(R.id.iv_custom3);
        ivCustom4 = (ImageView) rootView.findViewById(R.id.iv_custom4);
        ...
        btnBrowseNum = (TextView) rootView.findViewById(R.id.tv_browse_number);
        btnClosest = (TextView) rootView.findViewById(R.id.tv_the_closest);
        btnBestSell = (TextView) rootView.findViewById(R.id.tv_best_selling);
...
//        convenientBanner.setManualPageable(false);//设置不能手动影响
        ...
        convenientBanner.setPages(new CBViewHolderCreator<NetworkImageHolderView>() {
            ...
            public NetworkImageHolderView createHolder() {
                ...
                .setOnItemClickListener(new OnItemClickListener() {
                    @Override
                    public void onItemClick(int position) {
                        Toast.makeText(getActivity(), "广告：" + position, Toast.LENGTH_SHORT).show();
                    }
                })
                //设置两个点图片作为翻页指示器，不设置则没有指示器，可以根据自己需求自行配合自己的指示器,不需要圆点指示器可用不设
                .setPageIndicator(new int[]{R.drawable.ic_page_indicator, R.drawable.ic_page_indicator_focused});
    ...
    private void initRecyclerView() {
        ...
        adapter = new MyAdapter(getActivity(), loader);
        adapter.setOnRecyclerItemClickLitener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_index_scan:
                Toast.makeText(getActivity(), "跳转到扫码页面", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.tv_category_2:
                Toast.makeText(getActivity(), "超市", Toast.LENGTH_SHORT).show();
                break;
            case R.id.tv_category_3:
                Toast.makeText(getActivity(), "充值", Toast.LENGTH_SHORT).show();
                break;
            case R.id.tv_category_4:
                Toast.makeText(getActivity(), "旅游", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.tv_category_8:
                Toast.makeText(getActivity(), "丽人", Toast.LENGTH_SHORT).show();
                break;

            case R.id.iv_custom1:
                Toast.makeText(getActivity(), "Custom_1", Toast.LENGTH_SHORT).show();
                break;
            case R.id.iv_custom2:
                Toast.makeText(getActivity(), "Custom_2", Toast.LENGTH_SHORT).show();
                break;
            case R.id.iv_custom3:
                Toast.makeText(getActivity(), "Custom_3", Toast.LENGTH_SHORT).show();
                break;
            case R.id.iv_custom4:
                Toast.makeText(getActivity(), "Custom_4", Toast.LENGTH_SHORT).show();
                break;

            case R.id.tv_browse_number:
                Toast.makeText(getActivity(), "浏览次数", Toast.LENGTH_SHORT).show();
                break;
